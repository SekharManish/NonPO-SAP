    ...
    return BaseController.extend("com.sap.cp.dpa.invwpo.taskUI.controller.Approve", {
        ...
        _triggerComplete: function (processContext, taskId, approvalStatus ) {
            ...
            $.ajax({
                ...
                url: "/comsapcpdpainvwpotaskUI/workflowruntime/v1/xsrf-token",
                method: "GET",
                headers: {
                    "X-CSRF-Token": "Fetch"
                },
                success: function (result, xhr, data) {
                    ...
                    $.ajax({
                        ...
                        url: "/comsapcpdpainvwpotaskUI/workflowruntime/v1/task-instances/" + taskId,
                        method: "PATCH",
        ...
        getAttachments: function () {
            ...
            var sUrl = "/comsapcpdpainvwpotaskUI/docservice/workflowmanagement/NonPOVendorInvoiceDocuments/"+ workflowId +"?succinct=true";
        ...
        formatDownloadUrl: function (objectId) {
            return "/comsapcpdpainvwpotaskUI/docservice/workflowmanagement/NonPOVendorInvoiceDocuments/"
