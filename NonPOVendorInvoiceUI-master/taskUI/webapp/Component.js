sap.ui.define([
	...
	"sap/ui/Device",
    "com/sap/cp/dpa/invwpo/taskUI/model/models",
    "sap/ui/model/json/JSONModel"
], function (UIComponent, Device, models, JSONModel) {
	"use strict";

	return UIComponent.extend("com.sap.cp.dpa.invwpo.taskUI.Component", {
		...
		init: function () {
            ...
            var contextModel = new JSONModel("/comsapcpdpainvwpotaskUI/workflowruntime/v1/task-instances/" + taskId + "/context");
            ...
            var taskInstanceModel = new JSONModel("/comsapcpdpainvwpotaskUI/workflowruntime/v1/task-instances/" + taskId);
