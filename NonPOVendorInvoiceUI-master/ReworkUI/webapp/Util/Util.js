    ...
    return {
        ...
        getValueHelpDialog: function (oView, sName, bValidate, sInputValue, sCall, sParameter) {
            ...
            if (sName === "One-time Vendor Country" || sName === "Currency") {
                ...
                sUrl = "/comsapcpdpainvwpoReworkUI/bpmrulesruntime/rules-service/rest/v2/workingset-rule-services";
                ...
                if (this.sName === "Company Code") {
                    sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getCompanyCode";
                    ...
                    bTrigger = true;
                    if (bValidate) {
                        this.sUrl = sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getVendorcode";
                        oData = {
                    ...
                    sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getCostcentre";
                    ...
                    sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getPlantInfo";
                    this.sModelName = "plantModel";
                    oData = {
                        "plant": "*" + "*"
                    };
                    ...
                    if (this.invoiceDatePicker && this.invoiceDatePicker.getDateValue() || this.oView.byId("invoiceDate").getDateValue()) {
                        sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getPaymentTerm";
                    ...
                    if (oView.getModel('companyListModel').getProperty('/value')) {
                        sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getPaymentMethodDescription";
                    ...
                    sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getGLAccount";
                    ...
                    sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getTaxcode";
                    ...
                    sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getBusinessArea";
                    ...
                    sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getProfitCentre";
                    ...
                    this.sModelName = "requesterModel";
                      this.sUrl = sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getUserList";
                    bTrigger = true;
                    if (bValidate) {
                        oData = {
                            "userId": "*" + sInputValue + "*",
                    ...
                    if (this.sInputValue === "") {
                        ...
                        if (!Array.isArray(aList) && !aList.length) {
                            ...
                            if (this.sInputValue === aList.companyCode) {
                                ...
                                this.triggerBackendService({ "companyCode": this.sInputValue }, this.oView, "/comsapcpdpainvwpoReworkUI/CPI/http/getCurrency", "singleCurrency");
                            } else {
                    ...
                    if (this.sInputValue === "") {
                        ...
                        if (!Array.isArray(aList) && !aList.length) {
                            ...
                            if (this.sInputValue === aList.paymentTerm) {
                                this.oSelectedModel.setProperty("/error", "None");
                                this.oSelectedModel.setProperty("/desc", aList.description);
                                this.triggerBackendService({ "paymentTermKey": this.sInputValue }, this.oView, "/comsapcpdpainvwpoReworkUI/CPI/http/getPaymentkeyDuedetails");
        ...
        sendBackendRequest: function (fnFilterSearch, oModel, aSelectionSet) {
            ...
            if (this.sName === "Vendor") {
                sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getVendorcode";
                this.sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getVendorcode";
                sTitle = "Select Vendor";
                this.sModelName = "vendorListModel";
                oData = {
                ...
                this.sModelName = "internalOrderModel";
                sCode = "internalOrder";
                sUrl = "/comsapcpdpainvwpoReworkUI/CPI/http/getInternalOrder";
        ...
        _fetchToken: function () {
            var eToken;
            $.ajax({
                url: "/comsapcpdpainvwpoReworkUI/bpmrulesruntime/rules-service/v1/rules/xsrf-token",
                method: "GET",
                async: false,
                headers: {
                    "X-CSRF-Token": "Fetch"
        ...
        onValueHelpOkPress: function (oEvent) {
            ...
            if (this.sModelName === "companyListModel") {
                ...
                this.triggerBackendService({ "companyCode": sValue }, this.oView, "/comsapcpdpainvwpoReworkUI/CPI/http/getCurrency", "singleCurrency");
                ...
                this.triggerBackendService({ "paymentTermKey": sValue }, this.oView, "/comsapcpdpainvwpoReworkUI/CPI/http/getPaymentkeyDuedetails");
            } else if (this.sModelName === "currencyListModel") {
                if (!sValue && !sDesc) {
                    var aDataList = this.oSelectedModel.getProperty('/F4HelpList');
                    if (aDataList) {
