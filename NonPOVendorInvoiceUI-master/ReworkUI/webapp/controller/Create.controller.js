sap.ui.define(["com/sap/cp/dpa/invwpo/ReworkUI/controller/BaseController",
    ...
    return BaseController.extend("com.sap.cp.dpa.invwpo.ReworkUI.controller.Create", {
        ...
        formatDownloadUrl: function (objectId) {
            return "/comsapcpdpainvwpoReworkUI/docservice/workflowmanagement/NonPOVendorInvoiceDocuments/"
       ...
       // Formating the date pattern
        ...
        _triggerComplete: function (processContext, taskId, approvalStatus) {
            ...
            $.ajax({
                ...
                url: "/comsapcpdpainvwpoReworkUI/workflowruntime/v1/xsrf-token",
                method: "GET",
                headers: {
                    "X-CSRF-Token": "Fetch"
                },
                success: function (result, xhr, data) {
                    ...
                    $.ajax({
                        ...
                        url: "/comsapcpdpainvwpoReworkUI/workflowruntime/v1/task-instances/" + taskId,
                        method: "PATCH",
        ...
        checkIfFolderExists: function (folderName) {
            ...
            if (folderName == "workflowmanagement") {
                var sUrl = "/comsapcpdpainvwpoReworkUI/docservice/";
            } else if (folderName == "NonPOVendorInvoiceDocuments") {
                var sUrl = "/comsapcpdpainvwpoReworkUI/docservice/workflowmanagement/";
            } else {
                var sUrl = "/comsapcpdpainvwpoReworkUI/docservice/workflowmanagement/NonPOVendorInvoiceDocuments";
            }
            var oSettings = {
                "url": sUrl,
                "method": "GET",
            ...
            if (folderName == "workflowmanagement") {
                ...
                if (!folderExists) {
                    ...
                    oUploadCollection.setUploadUrl("/comsapcpdpainvwpoReworkUI/docservice/workflowmanagement/NonPOVendorInvoiceDocuments/" + folderName);
                }
            }
        },
        ...
        // Header details in Check Invoice details
           ...
           // Triggering Check Invoice
            jQuery.ajax({
                url: "/comsapcpdpainvwpoReworkUI/CPI/http/CheckInvoice",
                type: "POST",
                data: data,
                contentType: "application/json",
        ...
        getAttachments: function () {
            ...
            var sUrl = "/comsapcpdpainvwpoReworkUI/docservice/workflowmanagement/NonPOVendorInvoiceDocuments/" + workflowId + "?succinct=true";
        ...
        _triggerBackendCallToSaveChanges: function (sToken) {
            ...
            var oController = this;
            $.ajax({
                url: "/comsapcpdpainvwpoReworkUI/workflowruntime/v1/workflow-instances",
                method: "POST",
                async: false,
                contentType: "application/json",
                headers: {
        ...
        _populatePaymentTerm: function () {
            if (this.vendorflag && this.deadlockflag || this.companycodeflag && this.deadlockflag || this.invoicedateflag && this.deadlockflag) {
                ...
                if (sCC && sVendor) {
                    jQuery.ajax({
                        url: "/comsapcpdpainvwpoReworkUI/CPI/http/getVendorDetails",
                        type: "POST",
                        data: oData,
                        contentType: "application/json",
