sap.ui.define([
    ...
    return {
        ...
        getValueHelpDialog: function (oView, sName, bValidate, sInputValue, sCall, sParameter) {
            ...
            var sLanguage = sLang && sLang.split("-") && sLang.split("-")[0] && sLang.split("-")[0].toUpperCase();
            ...
            if (sName === "One-time Vendor Country" || sName === "Currency") {
                ...
                sUrl = "/comsapcpdpainvwpoStartUI/bpmrulesruntime/rules-service/rest/v2/workingset-rule-services";
                ...
                if (this.sName === "Company Code") {
                    ...
                    bTrigger = true;
                    if (bValidate) {
                        this.sUrl = sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getVendorcode";
                        oData = {
                    ...
                    sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getCostcentre";
                    ...
                    sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getPlantInfo";
                    this.sModelName = "plantModel";
                    oData = {
                        "plant": "*" + "*"
                    };
                    ...
                    if (this.invoiceDatePicker && this.invoiceDatePicker.getDateValue()) {
                        sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getPaymentTerm";
                    ...
                    if (oView.getModel('companyListModel').getProperty('/value')) {
                        sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getPaymentMethodDescription";
                    ...
                    sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getGLAccount";
                    ...
                    sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getTaxcode";
                    ...
                    sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getBusinessArea";
                    ...
                    sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getProfitCentre";
                    ...
                    sCode = "internalOrder";
                    sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getInternalOrder";
                    if (bValidate) {
                    ...
                    this.sUrl = sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getUserList";
                    bTrigger = true;
                    if (bValidate) {
                        oData = {
                            "userId": "*" + sInputValue + "*",
        ...
        handleFetchData: function (oView, sValue, bValidate, sCall, sResult) {
            ...
            if (sResult && sResult.root != "") {
                if (sValue === "singleCurrency") {
                    if (sResult.currency) {
                        this.sCountry = sResult.country;
                        this.storeCurrency(sResult.country);
                        this.currency = sResult.currency;
                    ...
                    if (this.sModelName === "companyListModel") {
                        ...
                        if (sResult && sResult.paymentTermList && Array.isArray(sResult.paymentTermList) && sResult.paymentTermList.length) {
                            ...
                            this.oView.byId("dueDatePicker").setValue(undefined);
                            if (this.invoiceDatePicker) {
                                var sInvoiceDate = this.invoiceDatePicker.getDateValue() && this.invoiceDatePicker.getDateValue().getTime(),
                            // Due Date Calcution based on Invoice date and Days fields     
                                oNewTime;
                                if (sResult.paymentTermDetails.dueDate3 && parseFloat(sResult.paymentTermDetails.dueDate3)) {
                                    if (this.oView.byId("dueDatePicker")) {
                                        oNewTime = new Date(sInvoiceDate);
                                        oNewTime.setDate(oNewTime.getDate() + parseInt(sResult.paymentTermDetails.dueDate3));
                                        this.oView.byId("dueDatePicker").setDateValue(new Date(oNewTime));
                                    }

                                } else if (sResult.paymentTermDetails.dueDate2 && parseFloat(sResult.paymentTermDetails.dueDate2)) {
                                    if (this.oView.byId("dueDatePicker")) {
                                        oNewTime = new Date(sInvoiceDate);
                                        oNewTime.setDate(oNewTime.getDate() + parseInt(sResult.paymentTermDetails.dueDate2));
                                        this.oView.byId("dueDatePicker").setDateValue(new Date(oNewTime));
                                    }
                                } else if (sResult.paymentTermDetails.dueDate1 && parseFloat(sResult.paymentTermDetails.dueDate1)) {
                                    if (this.oView.byId("dueDatePicker")) {
                                        oNewTime = new Date(sInvoiceDate);
                                        oNewTime.setDate(oNewTime.getDate() + parseInt(sResult.paymentTermDetails.dueDate1));
                                        this.oView.byId("dueDatePicker").setDateValue(new Date(oNewTime));
                                    }
                                } else {
                                     this.oView.byId("dueDatePicker").setDateValue(new Date(oNewTime));
            ...
            //change for internalorder description            
            if (this.sModelName === "internalOrderModel") {
                if (sCall === "SecondCall") {
                    ...
                    this.triggerBackendService(oParam, oView, "/comsapcpdpainvwpoStartUI/CPI/http/getInternalOrder", undefined, bValidate);
                } else {
                    if (oModel.getProperty("/ListAll") && oModel.getProperty("/ListAll").length) {
                    ...
                    if (this.sInputValue === "") {
                        ...
                        if (!Array.isArray(aList) && !aList.length) {
                            ...
                            if (this.sInputValue === aList.companyCode) {
                                ...
                                this.triggerBackendService({ "companyCode": this.sInputValue }, this.oView, "/comsapcpdpainvwpoStartUI/CPI/http/getCurrency", "singleCurrency");
                            } else {
                    ...
                    if (this.sInputValue === "") {
                        ...
                        if (!Array.isArray(aList) && !aList.length) {
                            ...
                            if (this.sInputValue === aList.paymentTerm) {
                                this.oSelectedModel.setProperty("/error", "None");
                                this.oSelectedModel.setProperty("/desc", aList.description);
                                this.triggerBackendService({ "paymentTermKey": this.sInputValue }, this.oView, "/comsapcpdpainvwpoStartUI/CPI/http/getPaymentkeyDuedetails");
        ...
        sendBackendRequest: function (fnFilterSearch, oModel, aSelectionSet) {
            ...
            if (this.sName === "Vendor") {
                ...
                this.sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getVendorcode";
                sTitle = "Select Vendor";
                this.sModelName = "vendorListModel";
                oData = {
        ...
        onValueHelpOkPress: function (oEvent) {
            ...
            if (this.sModelName === "companyListModel") {
                ...
                this.triggerBackendService({ "companyCode": sValue }, this.oView, "/comsapcpdpainvwpoStartUI/CPI/http/getCurrency", "singleCurrency");
                ...
                this.triggerBackendService({ "paymentTermKey": sValue }, this.oView, "/comsapcpdpainvwpoStartUI/CPI/http/getPaymentkeyDuedetails");
            } else if (this.sModelName === "currencyListModel") {
                if (!sValue && !sDesc) {
                    var aDataList = this.oSelectedModel.getProperty('/F4HelpList');
                    if (aDataList) {
        ...
        // Stroing country Currency 
        storeCurrency: function (currency) {
            this.sCountryCode = currency;
        },
        ...
        triggerCallToGetparameterData: function (oView, sName, bValidate, sValue) {
            ...
            if (sName === "Payment Methods") {
                sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getCurrency"
                oData = JSON.stringify({ "companyCode": oView.getModel('companyListModel').getProperty('/value') });
                this.sName = sName;

            } else {

                sUrl = "/comsapcpdpainvwpoStartUI/CPI/http/getTaxProcedure"
        ...
        handleTaxData: function (sJson) {
            ...
            if (this.bItemView) {
                this.addItemView.oController.getOwnerComponent().getRouter().navTo("Create", {}, true);
            }
